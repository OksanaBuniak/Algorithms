...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        double res = (double)(that.y - y) / (that.x - x);
        return res;
    }
    ...
    private class PointComparator implements Comparator<Point> {
        ...
        public int compare(Point o1, Point o2) {
            ...
            if ((slopeTo(o1) == Double.NEGATIVE_INFINITY && slopeTo(o2) == Double.NEGATIVE_INFINITY) ||
                (slopeTo(o1) == Double.POSITIVE_INFINITY && slopeTo(o2) == Double.POSITIVE_INFINITY) ||
                (slopeTo(o1) == +0.0 && slopeTo(o2) == +0.0) ||
    ...
    public static void main(String[] args) {
        ...
        File fil = new File("/users/Oksana/Downloads/collinear/input100.txt");
        In in = new In(fil);
        int n = in.readInt();
